...
export const Actions = () => {
    ...
    useEffect(() => {
        fetch("http://localhost:8080/tremglobalphp/all-users.php")
            .then((res) => {
                return res.json();
            })
            .then((data) => {
    ...
    const insertUser = (newUser) => {
        fetch("http://localhost:8080/tremglobalphp/add-user.php", {
            method: "POST",
            headers: {
    ...
    const updateUser = (userData) => {
        fetch("http://localhost:8080/tremglobalphp/update-user.php", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
    ...
    const deleteUser = (theID) => {
        ...
        fetch("http://localhost:8080/tremglobalphp/delete-user.php", {
            method: "POST",
            headers: {
                "Content-Type": "application/json",
            },
